...
disabled = st.session_state.get("role") == "viewer"

lcol,mcol,rcol = st.columns(3)

lcol.checkbox("Checkbox 1", disabled=disabled)
mcol.color_picker("Color Picker", disabled=disabled)
rcol.multiselect("Multiselect", ["Option 1", "Option 2", "Option 3"], disabled=disabled)

lcol.radio("Radio", ["Option 1", "Option 2", "Option 3"], disabled=disabled)
mcol.selectbox("Select Box", ["Option 1", "Option 2", "Option 3"], disabled=disabled)
rcol.select_slider("Select Slider", ["Option 1", "Option 2", "Option 3"], disabled=disabled)
